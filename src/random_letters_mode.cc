...
RandomLettersMode::RandomLettersMode() noexcept
    : Mode()
{
...
auto RandomLettersMode::destroy() const noexcept
    -> void
{}

auto RandomLettersMode::get_letters()
    -> std::vector<char>
{
    int my, mx;
...
auto RandomLettersMode::preprocess()
    -> std::vector<char>
{
    return get_letters();
}

auto RandomLettersMode::loop(const char i)
    -> void
{
    int my, mx;
...
auto RandomLettersMode::postprocess(std::chrono::duration<long,
